...
use crate::markdown::parse::{Item, ItemBody};
...
impl<T: Default> Tree<T> {
    ...
    pub fn remove_node(&mut self) -> Option<TreeIndex> {
    ...
    pub fn truncate_to_parent(&mut self, child_ix: TreeIndex) {
...
impl Tree<Item> {
    ...
    pub fn truncate_siblings(&mut self, end_byte_ix: usize) {
